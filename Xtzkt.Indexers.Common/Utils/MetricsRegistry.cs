...
public static class MetricsRegistry
{
    ...
    public static void SetHealthValue(this IMeasureGaugeMetrics metrics, Data.Models.Chain state)
    {
        metrics.SetValue(Synced, state.KnownLevel == state.Level ? 1.0 : 0.0);
        metrics.SetValue(SyncGap, state.KnownLevel - state.Level);
    }
    #endregion
