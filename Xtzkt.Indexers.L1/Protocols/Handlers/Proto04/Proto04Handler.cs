...
using Xtzkt.Indexers.L1.Protocols.Proto04;

namespace Xtzkt.Indexers.L1.Protocols
{
    class Proto04Handler : ProtocolHandler
    {
        ...
        public Proto04Handler(TezosNode node, XtzktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto04Handler> logger, IMetrics metrics)
