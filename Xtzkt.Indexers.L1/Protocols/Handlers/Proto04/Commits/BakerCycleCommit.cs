...
{
    class BakerCycleCommit(ProtocolHandler protocol) : Proto01.BakerCycleCommit(protocol)
    {
            ...
            List<BakingRight> currentRights)
        {
            ...
            if (block.Events.HasFlag(L1BlockEvents.CycleBegin))
            {
                ...
                var snapshotProtocol = await Cache.Protocols.GetAsync(snapshotBlock.ProtocolId);
                //---------------------------------------------
