...
using Xtzkt.Indexers.L1.Protocols.Proto02;

namespace Xtzkt.Indexers.L1.Protocols
{
    class Proto02Handler : ProtocolHandler
    {
        ...
        public Proto02Handler(TezosNode node, XtzktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto02Handler> logger, IMetrics metrics)
