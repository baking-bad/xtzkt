...
using Xtzkt.Indexers.L1.Protocols.Proto12;
...
namespace Xtzkt.Indexers.L1.Protocols
{
    class Proto12Handler : ProtocolHandler
    {
        ...
        public Proto12Handler(TezosNode node, XtzktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto12Handler> logger, IMetrics metrics)
