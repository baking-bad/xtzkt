...
using Xtzkt.Indexers.L1.Protocols.Proto22;
...
namespace Xtzkt.Indexers.L1.Protocols
{
    class Proto22Handler : ProtocolHandler
    {
        ...
        public Proto22Handler(TezosNode node, XtzktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto22Handler> logger, IMetrics metrics)
