...
using Xtzkt.Indexers.L1.Protocols.Proto09;

namespace Xtzkt.Indexers.L1.Protocols
{
    class Proto09Handler : ProtocolHandler
    {
        ...
        public Proto09Handler(TezosNode node, XtzktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto09Handler> logger, IMetrics metrics)
