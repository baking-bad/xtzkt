...
using Xtzkt.Indexers.L1.Protocols.Proto25;

namespace Xtzkt.Indexers.L1.Protocols
{
    class Proto25Handler : ProtocolHandler
    {
        public override IDiagnostics Diagnostics { get; }
        public override IHelpers Helpers { get; }
        public override IValidator Validator { get; }
        public override IRpc Rpc { get; }
        public override string VersionName => "u025_025";
        public override int VersionNumber => 25;

        public Proto25Handler(TezosNode node, XtzktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto25Handler> logger, IMetrics metrics)
