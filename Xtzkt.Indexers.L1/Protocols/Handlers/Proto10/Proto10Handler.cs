...
using Xtzkt.Indexers.L1.Protocols.Proto10;
...
namespace Xtzkt.Indexers.L1.Protocols
{
    class Proto10Handler : ProtocolHandler
    {
        ...
        public Proto10Handler(TezosNode node, XtzktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto10Handler> logger, IMetrics metrics)
