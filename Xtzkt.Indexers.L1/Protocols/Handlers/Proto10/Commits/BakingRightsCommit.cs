...
{
    class BakingRightsCommit(ProtocolHandler protocol) : Proto03.BakingRightsCommit(protocol)
    {
        ...
        protected override async Task<IEnumerable<JsonElement>> GetAttestationRights(L1Block block, L1Protocol protocol, int cycle)
        {
