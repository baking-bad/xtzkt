...
using Xtzkt.Indexers.L1.Protocols.Proto07;

namespace Xtzkt.Indexers.L1.Protocols
{
    class Proto07Handler : ProtocolHandler
    {
        ...
        public Proto07Handler(TezosNode node, XtzktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto07Handler> logger, IMetrics metrics)
