...
using Xtzkt.Indexers.L1.Protocols.Proto01;

namespace Xtzkt.Indexers.L1.Protocols
{
    class Proto01Handler : ProtocolHandler
    {
        ...
        public Proto01Handler(TezosNode node, XtzktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto01Handler> logger, IMetrics metrics)
