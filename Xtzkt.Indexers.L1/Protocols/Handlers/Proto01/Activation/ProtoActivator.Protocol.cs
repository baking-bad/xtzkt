...
namespace Xtzkt.Indexers.L1.Protocols.Proto01
{
    ...
    {
        public (L1Protocol, JToken) BootstrapProtocol(JsonElement rawBlock)
        {
        ...
        protected virtual void SetParameters(L1Protocol protocol, JToken parameters)
        {
            ...
            protocol.AttestationReward0 = parameters["endorsement_reward"]?.Value<long>() ?? 2_000_000;
        ...
        public async Task UpgradeProtocol(L1Chain state)
        {
            ...
            var protocol = new L1Protocol
            {
                ...
                BakerParametersActivationDelay = prev.BakerParametersActivationDelay,
        ...
        public async Task DowngradeProtocol(L1Chain state)
        {
        ...
        protected virtual void UpgradeParameters(L1Protocol protocol, L1Protocol prev) { }
    }
}
