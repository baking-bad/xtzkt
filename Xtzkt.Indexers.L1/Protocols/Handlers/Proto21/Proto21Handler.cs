...
using Xtzkt.Indexers.L1.Protocols.Proto21;

namespace Xtzkt.Indexers.L1.Protocols
{
    class Proto21Handler : ProtocolHandler
    {
        ...
        public Proto21Handler(TezosNode node, XtzktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto21Handler> logger, IMetrics metrics)
