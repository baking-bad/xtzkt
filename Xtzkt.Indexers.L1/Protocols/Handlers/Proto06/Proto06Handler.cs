...
using Xtzkt.Indexers.L1.Protocols.Proto06;

namespace Xtzkt.Indexers.L1.Protocols
{
    class Proto06Handler : ProtocolHandler
    {
        ...
        public Proto06Handler(TezosNode node, XtzktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto06Handler> logger, IMetrics metrics)
