...
using Xtzkt.Indexers.L1.Protocols.Proto19;

namespace Xtzkt.Indexers.L1.Protocols
{
    class Proto19Handler : ProtocolHandler
    {
        ...
        public Proto19Handler(TezosNode node, XtzktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto19Handler> logger, IMetrics metrics)
