...
using Xtzkt.Indexers.L1.Protocols.Proto18;

namespace Xtzkt.Indexers.L1.Protocols
{
    class Proto18Handler : ProtocolHandler
    {
        ...
        public Proto18Handler(TezosNode node, XtzktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto18Handler> logger, IMetrics metrics)
