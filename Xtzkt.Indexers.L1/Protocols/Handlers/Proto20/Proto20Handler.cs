...
using Xtzkt.Indexers.L1.Protocols.Proto20;
...
namespace Xtzkt.Indexers.L1.Protocols
{
    class Proto20Handler : ProtocolHandler
    {
        ...
        public Proto20Handler(TezosNode node, XtzktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto20Handler> logger, IMetrics metrics)
