...
using Xtzkt.Indexers.L1.Protocols.Proto15;
...
namespace Xtzkt.Indexers.L1.Protocols
{
    class Proto15Handler : ProtocolHandler
    {
        ...
        public Proto15Handler(TezosNode node, XtzktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto15Handler> logger, IMetrics metrics)
