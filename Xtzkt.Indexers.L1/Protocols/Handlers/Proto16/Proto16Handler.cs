...
using Xtzkt.Indexers.L1.Protocols.Proto16;

namespace Xtzkt.Indexers.L1.Protocols
{
    class Proto16Handler : ProtocolHandler
    {
        ...
        public Proto16Handler(TezosNode node, XtzktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto16Handler> logger, IMetrics metrics)
