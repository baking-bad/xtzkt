...
using Xtzkt.Indexers.L1.Protocols.Proto11;
...
namespace Xtzkt.Indexers.L1.Protocols
{
    class Proto11Handler : ProtocolHandler
    {
        ...
        public Proto11Handler(TezosNode node, XtzktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto11Handler> logger, IMetrics metrics)
