...
using Xtzkt.Indexers.L1.Protocols.Proto05;

namespace Xtzkt.Indexers.L1.Protocols
{
    class Proto05Handler : ProtocolHandler
    {
        ...
        public Proto05Handler(TezosNode node, XtzktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto05Handler> logger, IMetrics metrics)
