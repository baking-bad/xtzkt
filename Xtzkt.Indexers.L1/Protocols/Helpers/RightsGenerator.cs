...
namespace Xtzkt.Indexers.L1.Protocols
{
    class RightsGenerator
    {
        ...
        public static async Task<IEnumerable<BR>> GetBakingRightsAsync(Sampler sampler, L1Protocol protocol, Cycle cycle)
        {
        ...
        public static async Task<IEnumerable<AR>> GetAttestationRightsAsync(Sampler sampler, L1Protocol protocol, Cycle cycle)
        {
        ...
        public static IEnumerable<AR> GetAttestationRights(Sampler sampler, L1Protocol protocol, Cycle cycle, int level)
        {
            var generator = new RightsGenerator(sampler, cycle.Seed);
