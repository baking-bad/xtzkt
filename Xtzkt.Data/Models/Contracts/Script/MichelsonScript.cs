...
{
    public class MichelsonScript() : Script(Runtime.Michelson)
    {
        public required byte[] ParameterSchema { get; set; }
        public required byte[] StorageSchema { get; set; }
        public required byte[] CodeSchema { get; set; }
        ...
        #region manager.tz
        public static readonly byte[] ManagerTzBytes =
        [
    ...
    public static class MichelsonScriptModel
    {
        public static void BuildMichelsonScriptModel(this ModelBuilder modelBuilder)
        {
        }
    }
}
