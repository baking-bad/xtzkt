...
namespace Xtzkt.Indexers.TezosX.Protocols.Proto03
{
    partial class OriginationCommit(ProtocolHandler protocol) : ProtocolCommit(protocol)
    {
        ...
        public virtual async Task<XEvmOriginationOperation> ApplyInternalEvm(IParentOperation parent, JsonElement trace, OperationStatus traceStatus, OperationStatus parentTraceStatus)
        {
            #region init
            var block = Context.Block;
