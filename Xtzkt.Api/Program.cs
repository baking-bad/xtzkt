...
builder.Services.AddTransient<BridgeTicketRepository>();
builder.Services.AddTransient<BridgeTicketBalanceRepository>();
builder.Services.AddTransient<BridgeTicketTransferRepository>();
