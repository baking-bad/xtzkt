...
[JsonDerivedType(typeof(L1RevealOperation), Layers.L1)]
[JsonDerivedType(typeof(XRevealOperation), Layers.TezosX)]
public abstract class RevealOperation : IOpgActivity
{
    ...
    /// <summary>Address that revealed its public key.</summary>
...
public class L1RevealOperation : RevealOperation
{
    /// <summary>Fee paid to the baker for including the operation (mutez).</summary>
    public long BakerFee { get; set; }
}

public class XRevealOperation : RevealOperation
{
