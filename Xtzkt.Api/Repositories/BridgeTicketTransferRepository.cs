    ...
    NpgsqlDataSource _dataSource)
{
    ...
    async Task<List<IdRange>?> ProcessFilters(BridgeTicketTransferFilter filter, Pagination? pagination = null)
    {
    ...
    public async Task<IEnumerable<IOpgActivity>> Activity(List<long> transactionIds, List<long> depositIds, ActivityPagination pagination)
    {
