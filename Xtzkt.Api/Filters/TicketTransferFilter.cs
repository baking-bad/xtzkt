...
public class TicketTransferFilter : INormalizable
{
    ...
    /// Click on the parameter to expand more details.
    ///
    /// Examples: `?from=tz1...`, `?from.null=true`.
    /// </summary>
    ...
    /// <summary>
    /// Filters by the transfer_ticket operation that caused the transfer.
    ///
    /// Click on the parameter to expand more details.
    ///
    /// Example: `?transferTicketId=123`.
    /// </summary>
    public Int64NullParameter? TransferTicketId { get; set; }

    /// <summary>
    /// Filters by the smart_rollup_execute operation that caused the transfer.
    ///
    /// Click on the parameter to expand more details.
    ///
    /// Example: `?smartRollupExecuteId=123`.
    /// </summary>
    ...
    public string Normalize(string name) => ResponseCacheService.BuildKey("",
        ...
        ($"{name}.transferTicketId", TransferTicketId),
        ($"{name}.smartRollupExecuteId", SmartRollupExecuteId),
        ($"{name}.or", Or));
}
