...
[ModelBinder(BinderType = typeof(HashBinder))]
public class HashParameter : INormalizable
{
    /// <summary>
    ...
    public static implicit operator HashParameter(string value) => new() { Eq = value };
