...
[ModelBinder(BinderType = typeof(Int32RangeBinder))]
public class Int32RangeParameter : INormalizable
{
    /// <summary>
    ...
    public static implicit operator Int32RangeParameter(int eq) => new() { Eq = eq };
}
