...
[ModelBinder(BinderType = typeof(MichelsonBlockHashBinder))]
public class MichelsonBlockHashParameter : INormalizable
{
    /// <summary>
    ...
    ///
    /// Example: `?hash.ni=B...,BLyyyy...`.
    /// </summary>
    public List<string>? Ni { get; set; }

    public static implicit operator MichelsonBlockHashParameter(string value) => new() { Eq = value };
